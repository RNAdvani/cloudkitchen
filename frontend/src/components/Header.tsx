...
import { Menu, User as UserPic, X } from 'lucide-react'
        ...
        <div className="hidden  lg:block">
          {
            ...
            type="button"
            className="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 ml-3 focus-visible:outline-offset-2 focus-visible:outline-black"
          >
            <UserPic />
          </button>
          ...
          {
          isDialogOpen ? (
            <div className='absolute text-lg flex rounded-lg flex-col py-[1rem] px-[1.5rem] mt-2 translate-x-[-20%] bg-white text-center z-20'>
            <Link to={"/"}>Home</Link>
            <Link to={"/"} >About</Link>
