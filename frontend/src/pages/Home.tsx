      ...
      <div className="relative w-full ">
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
            ...
            {
              user ? (user.role === "admin"?"Take our cloud to soaring heights" : "Discover wonderful chefs") : "Join to discover food from Professional chefs"
            }
            </h1>
          ...
          <div className="relative lg:col-span-5 lg:-mr-8 xl:col-span-6">
            <img
              className="aspect-[3/2] bg-gray-50 object-cover lg:aspect-[4/3] lg:h-[650px] xl:aspect-[16/9]"
              src="ck2.jpg"
              alt=""
            />
          </div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-6">
          ...
          <div className="flex flex-col items-center justify-center md:flex-row lg:col-span-7">
            <div className="w-full p-5 md:w-1/2">
              <div className="rounded-md border  bg-opacity-90">
